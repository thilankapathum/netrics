...
public interface LteFddKpiDayRepository extends JpaRepository<LteFddKpiDay, Long> {
    ...
    Optional<LteFddKpiDaySnap> getKpiSnapshot(@Param("standardKpiId") Long standardKpiId, @Param("timestamp") LocalDateTime timestamp, @Param("period") Long period);
